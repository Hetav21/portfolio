...
<figure className="video-embed" style={{ margin: '2.5rem 0', textAlign: 'center' }}>
  ...
  <noscript>
    <p>
      <strong>Video:</strong> <a href="https://www.youtube.com/watch?v=VIDEO_ID">VIDEO_TITLE_ESC</a>{' '}
      by CHANNEL_NAME_ESC. DESCRIPTION_EXCERPT_ESC
    </p>
  </noscript>
</figure>
```
...
<figure class="video-embed" style="margin: 2.5rem 0; text-align: center;">
  ...
  <noscript>
    <p>
      <strong>Video:</strong>
      <a href="https://www.youtube.com/watch?v=VIDEO_ID">VIDEO_TITLE_ESC</a> by CHANNEL_NAME_ESC.
      DESCRIPTION_EXCERPT_ESC
    </p>
  </noscript>
</figure>
```
