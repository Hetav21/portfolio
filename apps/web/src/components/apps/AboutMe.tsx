  ...
  return (
    <div className="h-full bg-card text-foreground overflow-auto p-8 flex flex-col items-center">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-muted-foreground">Associate AI Engineer</p>
      </div>
        ...
        <div className="bg-secondary rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="p-4 flex flex-wrap gap-2">
            {[
              ...
              <span
                key={tech}
                className="px-3 py-1 bg-muted rounded-full text-sm hover:bg-muted transition-colors cursor-default"
              >
                {tech}
              </span>
            ))}
