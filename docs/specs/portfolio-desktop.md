...
- **Apps**: Terminal (with virtual filesystem and command parser), Files, About Me, Projects, Contact, Text Editor, and Web Browser. Includes mobile redirect to portfolio.
